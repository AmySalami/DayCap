...
- **สัปดาห์ = อาทิตย์→เสาร์**, ปฏิทินเรียง อา.→ส. — **เปลี่ยนวันด้วยการแตะปฏิทินเท่านั้น** (เอา swipe-เปลี่ยนวันออกแล้ว เพราะมีแค่ 7 วัน แตะเดียวถึง + กัน gesture ชนกับ pager)
...
- **Home:** วิดีโอเต็มจอ autoplay + progress dots + ป้ายเวลา + ปุ่ม Share (ขวาบน) + Adjust zone (glass: ที่จับ + ปฏิทิน)
  - gesture: **ปัดแนวนอนทั้งหน้า = เข้ากล้อง (finger-tracked pager, 1:1 + commit/cancel)**, ปัดลงบนการ์ด = **Edit mode (morph inline)**, เปลี่ยนวัน = แตะปฏิทิน
...
| 2026-07-05 | Exp/Tech | กล้อง↔Home = finger-tracked interactive transition (จอตามนิ้ว 1:1 + fling commit/cancel), Timeline pan มี momentum + พักวิดีโอ Home ตอนอยู่กล้อง (กันกระตุก) |
| 2026-07-05 | Experience | เอา swipe-เปลี่ยนวันออก → ปัดแนวนอนทั้งหน้า Home = เข้ากล้องแทน (consistency กับหน้ากล้อง), เปลี่ยนวันใช้แตะปฏิทิน |
